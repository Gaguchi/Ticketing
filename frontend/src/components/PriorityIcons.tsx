...
export const PriorityBacklogOutlined: React.FC<PriorityIconProps> = ({
  color,
}) => {
  return (
    <span
...
export const PriorityHighOutlined: React.FC<PriorityIconProps> = ({
  color,
}) => {
  return (
    <span
...
export const PriorityNormalOutlined: React.FC<PriorityIconProps> = ({
  color,
}) => {
  return (
    <span
...
export const PriorityUrgentOutlined: React.FC<PriorityIconProps> = ({
  color,
}) => {
  return (
    <span
...
export const getPriorityIcon = (priorityId: number) => {
  switch (priorityId) {
    case 1:
      return <PriorityBacklogOutlined />;
    case 2:
      return <PriorityNormalOutlined />;
    case 3:
      return <PriorityHighOutlined />;
    case 4:
      return <PriorityUrgentOutlined />;
    default:
      return <PriorityBacklogOutlined />;
  }
};
