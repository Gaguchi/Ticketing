...
class ChatService {
   ...
   * @deprecated Use getMessages with options instead
   */
  async getMessagesLegacy(roomId: number): Promise<ChatMessage[]> {
    const result = await this.getMessages(roomId, { limit: 100 });
